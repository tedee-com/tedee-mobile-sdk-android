...
```gradle
dependencies {
  implementation("com.github.tedee-com:tedee-mobile-sdk-android:v0.0.3@aar") { isTransitive = true }
}
```
...
```gradle
dependencies {
  implementation("com.github.tedee-com:tedee-mobile-sdk-android:v0.0.3@aar") { transitive = true }
}
```
